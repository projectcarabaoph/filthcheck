    ...
    return (
        <div className="relative overflow-hidden flex flex-col items-center  text-center py-20">
            ...
            <div className="w-full flex gap-4 justify-center flex-col md:flex-row">
                ...
                <Link href={paths.documentation.docs} className="border-2 border-gray-300 text-gray-700 px-8 py-2 rounded-lg font-semibold hover:border-gray-400 transition-colors">
                    View Documentation
                </Link>
            </div>
        </div>
